...
import img_1 from "./item_2_5.gif";
...
const Size230mm = () => {
  ...
  const SizeList = document.getElementById("Size_list");
  SizeList.style.display = "none";
  Size.innerHTML = "&nbsp;230mm";
};
const Size235mm = () => {
  const Size = document.getElementById("Size");
  const SizeList = document.getElementById("Size_list");
  SizeList.style.display = "none";
  Size.innerHTML = "&nbsp;235mm";
};
const Size240mm = () => {
  const Size = document.getElementById("Size");
  const SizeList = document.getElementById("Size_list");
  SizeList.style.display = "none";
  Size.innerHTML = "&nbsp;240mm";
};
const Size245mm = () => {
  const Size = document.getElementById("Size");
  const SizeList = document.getElementById("Size_list");
  SizeList.style.display = "none";
  Size.innerHTML = "&nbsp;245mm";
};
        ...
        <Row id="Item_row">
          ...
          <Col lg={6} md={6} sm={6} xs={12} id="Item_p">
            ...
            <div className={style.Size_list} id="Size_list">
              <p onClick={Size230mm} id="Size_230mm_2">
                230mm
              </p>
              <p onClick={Size235mm} id="Size_235mm_2">
                235mm
              </p>
              <p onClick={Size240mm} id="Size_240mm_2">
                240mm
              </p>
              <p onClick={Size245mm} id="Size_245mm_2">
                245mm
              </p>
              <p onClick={Size250mm} id="Size_250mm_2">
                250mm
              </p>
              <p onClick={Size260mm} id="Size_260mm_2">
                260mm
              </p>
              <p onClick={Size265mm} id="Size_265mm_2">
                265mm
              </p>
              <p onClick={Size270mm} id="Size_270mm_2">
                270mm
              </p>
              <p onClick={Size275mm} id="Size_275mm_2">
                275mm
              </p>
              <p onClick={Size280mm} id="Size_280mm_2">
                280mm
              </p>
            </div>
