...
import img_1 from "./item_2_4.gif";
        ...
        <Row id="Item_row">
          ...
          <Col lg={6} md={6} sm={6} xs={12} id="Item_p">
            ...
            <div className={style.Size_list} id="Size_list">
              <p onClick={Size245mm} id="Size_245mm_1">
                245mm
              </p>
              <p onClick={Size250mm} id="Size_250mm_1">
                250mm
              </p>
              <p onClick={Size260mm} id="Size_260mm_1">
                260mm
              </p>
              <p onClick={Size265mm} id="Size_265mm_1">
                265mm
              </p>
              <p onClick={Size270mm} id="Size_270mm_1">
                270mm
              </p>
              <p onClick={Size275mm} id="Size_275mm_1">
                275mm
              </p>
              <p onClick={Size280mm} id="Size_280mm_1">
                280mm
              </p>
            </div>
